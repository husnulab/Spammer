...
\____/| .__/ \__,_|_| |_| |_| \____/|_| |_| |_|___/
	...
	def Phd(Phone, Amount):
		...
		for _ in range(Amount):
			...
			'phone_number' : Phone,
			'birthday' : '0000-00-00',
			'username' : 'ZFFCYBER@gmail.com',
			'password' : 'SUBSCRIBE ZEF12',
			'agreeterms' : '1'
			}
...
if __name__ == '__main__':
	...
	sleep(2)
	os.system('clear')
	os.system('xdg-open https://www.youtube.com/channel/UCib5fz-YlkgfECONodVTKgg')
	sleep(7)
	Spam()